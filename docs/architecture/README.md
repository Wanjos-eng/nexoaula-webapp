...
O frontend atual é uma demonstração navegável com mocks. A API possui migration,
persistência de usuário/perfil e cadastro HTTP. Login, sessão e integração com o
frontend ainda não estão concluídos.
